...
working_directory = "/Users/fernando/Documents/Research/LLM_SR_medicine/llm_results/PNP/"
original_dataset = pd.read_pickle(f"{working_directory}PNP_preprocessed.pkl")
