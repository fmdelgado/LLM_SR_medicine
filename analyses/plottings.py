...
metrics = ['Precision', 'Recall',"Specificity",  'F1-score', 'Matthews correlation coefficient', "Cohen's kappa", 'PABAK']
metrics = ['Precision', 'Recall',"Specificity",  'F1-score', 'Matthews correlation coefficient', 'PABAK']

range_0_1 = ['Precision', 'Recall', "Specificity",  'F1-score']
...
models = ["gpt-4o-mini-2024-07-18", "gpt-4o-2024-05-13",'reflection:70b', 'gemma2:27b',
...
test = df_subset_alltrue.groupby('Model').agg({'Odds Ratio': 'mean', 'P-value': 'mean', 'Precision': 'mean', 'Recall': 'mean', "Specificity":"mean", 'F1-score': 'mean', 'Matthews correlation coefficient': 'mean', 'Cohen\'s kappa': 'mean', 'PABAK': 'mean', '-log10(P-value)': 'mean'})
...
test2 = df_subset_RF.groupby('Model').agg({'Odds Ratio': 'mean', 'P-value': 'mean', 'Precision': 'mean', 'Recall': 'mean', "Specificity":"mean", 'F1-score': 'mean', 'Matthews correlation coefficient': 'mean', 'Cohen\'s kappa': 'mean', 'PABAK': 'mean'})
